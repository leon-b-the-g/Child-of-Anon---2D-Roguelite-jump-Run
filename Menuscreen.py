...
def play_game():
    ...
    #Turn this into a pause button at the top of the screen
    PLAY_BACK = Button(image=None, pos=(980, 40), 
                        text_input="Pause", font=get_font(75), base_color="White", hovering_color="Green")
